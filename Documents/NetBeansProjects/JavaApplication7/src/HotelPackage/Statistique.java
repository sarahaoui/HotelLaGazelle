...
Connection con  =null;
 ...
 public int click=0;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(21, 14, 160, 32);
        ...
        Bsupprimer.setText("Réservation Salle");
        ...
        Bsupprimer.setBounds(280, 20, 230, 43);
        ...
        BNouveau.setText("RéservationChambre");
        ...
        BNouveau.setBounds(20, 20, 230, 43);
        ...
        jPanel2.add(BFiche);
        BFiche.setBounds(530, 20, 230, 43);

        panel.setBackground(new java.awt.Color(102, 102, 102));
        panel.setLayout(new java.awt.BorderLayout());
        jPanel2.add(panel);
        panel.setBounds(300, 150, 800, 460);
...
try{
            String query= "SELECT  MONTH(CAST(DateD AS Date)),count(*)  FROM reservationsalle GROUP by(MONTH(CAST(DateD AS Date)))";
            ...
            JFreeChart barchart = ChartFactory.createBarChart("Nombre de réservation des salles par mois","Le Mois" ,"Le Nombre", dataset, PlotOrientation.VERTICAL, false, true, true);
    ...
    private void BNouveauActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BNouveauActionPerformed
      try{
            ...
            String query= "SELECT  MONTH(CAST(DateD AS Date)),count(*)  FROM reservationchambre GROUP by(MONTH(CAST(DateD AS Date)))";
            Class.forName("com.mysql.jdbc.Driver");
            System.err.println("connected");
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hotellagazelle","root","");
            JDBCCategoryDataset dataset = new JDBCCategoryDataset(con,query);
            JFreeChart barchart = ChartFactory.createBarChart("Nombre de réservation des chambres par mois","Le Mois" ,"Le Nombre", dataset, PlotOrientation.VERTICAL, false, true, true);
