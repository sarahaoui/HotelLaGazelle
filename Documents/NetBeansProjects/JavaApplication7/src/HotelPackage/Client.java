...
public class Client extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        table.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(255, 186, 162), new java.awt.Color(0, 0, 0)));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nom", "Prenom", "Date", "Lieu", "natio", "n carte", "TypePaiment", "Profession", "Type_pièce", "Tlf", "email", "nbr_enf", "nbr_adu"
            }
        ));
        table.setFocusable(false);
        table.setGridColor(new java.awt.Color(2, 5, 8));
        ...
        jScrollPane1.setBounds(30, 160, 1131, 333);
        ...
        try{
           Class.forName("com.mysql.jdbc.Driver");
            ...
            while(rs.next()){
                ...
                String date=String.valueOf(rs.getString("Date_nai"));
                String lieu=String.valueOf(rs.getString("Lieu_nai"));
                String natio=String.valueOf(rs.getString("Nationalité"));
                String numcarte=String.valueOf(rs.getInt("n°carteN"));
                String type=String.valueOf(rs.getString("TypePaiment"));
                String profess=String.valueOf(rs.getString("Profession"));
                String piece=String.valueOf(rs.getString("Type_pièce"));
                String tlf=String.valueOf(rs.getInt("Téléphone"));
                String mail=String.valueOf(rs.getString("Email"));
                String nbr_enf=String.valueOf(rs.getInt("Nbr_enf"));
                String nbr_adulte=String.valueOf(rs.getInt("Nbr_adulte"));
                
                //store in table
                
                String Table[]={idclient,Nom,Prenom,date,lieu,natio,numcarte,type,profess, piece,tlf,mail,nbr_enf,nbr_adulte};
